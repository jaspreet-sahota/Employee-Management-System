...
const ViewStoreSchedule: FunctionComponent = () => {
  ...
  useEffect(() => {
    ...
    console.log('Extracted values:', extractedStoreId, extractedManagerId);
    ...
    if (extractedManagerId) {
      fetchShifts(extractedManagerId);
    }
  }, [location]);
...
export default ViewStoreSchedule;
